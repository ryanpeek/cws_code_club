...
#### *`r icons::icon_style(icons::fontawesome("r-project"),  color="steelblue", size=1.5, pull="left")` Lessons & Tutorials*
...
#### *`r icons::icon_style(icons::fontawesome("book"), color="black", size=1.5, pull="left")` eBooks/Courses*
...
#### *`r icons::icon_style(icons::fontawesome("github"), color="gray50", size=1.5, pull="left")` Git/Github* 
...
#### *`r icons::icon_style(icons::fontawesome("database"), color="slateblue", size=1.5, pull="left")` Lesson Datasets*
...
#### *`r icons::icon_style(icons::fontawesome("code"), color="forestgreen", size=1.5, pull="left")` LiveCode*
 ...
 - [2021-01-28](https://raw.githubusercontent.com/ryanpeek/cws_code_club/main/code/2021-01-28_livecode.R): Short date/datetimes/timezones tutorial
  - [2021-05-06](https://raw.githubusercontent.com/ryanpeek/cws_code_club/main/code/2021-05-06_livecode.R): Building your own functions tutorial
