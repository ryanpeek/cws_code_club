...
This becomes especially important when using computer programming like `r icons::fontawesome("r-project")` in your work. You will need to tell R, very specifically, where you are and where your files are in the forest of your computer. Where you are is typically referred to as the **working directory**. In `r icons::fontawesome("r-project")`, think of this as your homebase, and everything is *relative* to this folder/location on your computer.
...
knitr::include_graphics(path="slides/images/rstudio-workspace-default.png")
...
```{r filenameMadness, echo=F, eval=T}

knitr::include_graphics("https://gge-ucd.github.io/R-DAVIS/img/phd052810s.gif")
...
At a minimum, it’s useful to have separate directories for each of the following:
 ...
 - **`scripts`**: In the `r icons::fontawesome("r-project")` world, this is generally `.R` files. However, maybe you have `.do` files if Stata is your thing, `.py` files for Python, etc. Using a sequential numbering file naming scheme can be useful. Remember to pad with a zero to make file sorting/ordering easy.
